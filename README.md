El ejercicio consta de la creación de una clase 'TiendaOnline', que servirá como 'plantilla' para introducir datos, ya predeterminados en esta clase, sobre diferentes instancias, en este caso ecommerces.
